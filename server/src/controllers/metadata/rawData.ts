  ...
  bdsima: [
    {
      ...
      description:
        "Definições de campos / sensores disponíveis no SIMA (nome, rótulo, unidade, ordem).",
      colunas: [
    ...
    },
    {
      ...
      description:
        "Catálogo de sensores usados nas estações (fabricante, modelo, faixa, precisão).",
      colunas: [
        { nome: "idSensor", label: "ID Sensor", type: "number" },
    ...
    },
    {
      ...
      description:
        "Séries temporais coletadas pelo SIMA (vento, temperatura, sondas, radiação, CO₂, precipitação, etc.).",
      colunas: [
    ...
    },
    {
      ...
      description:
        "Versão offline/histórica dos dados SIMA (registro de sensores quando não havia link online).",
      colunas: [
        { nome: "idestacao", label: "ID Estação", type: "string" },
        { nome: "dataHora", label: "Data e Hora", type: "date" },
        { nome: "dirvt", label: "Direção do vento (°)", type: "number" },
