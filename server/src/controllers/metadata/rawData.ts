...
const rawData: Record<string, TableMeta[]> = {
 ...
 // front/src/data/simaMetadata.ts
// Metadados para o conjunto SIMA (seguindo o modelo fornecido)

export const bdsima = [
  {
    id: "tbcampotabela",
    name: "Campo Tabela (metadados de campo)",
    description: "Definições de campos / sensores disponíveis no SIMA (nome, rótulo, unidade, ordem).",
    colunas: [
      { nome: "idcampotabela", label: "ID Campo Tabela", type: "number" },
      { nome: "idsensor", label: "ID Sensor", type: "number" },
      { nome: "nomecampo", label: "Nome do Campo", type: "string" },
      { nome: "rotulo", label: "Rótulo", type: "string" },
      { nome: "unidademedida", label: "Unidade de Medida", type: "string" },
      { nome: "ordem", label: "Ordem", type: "number" },
    ],
    responsible: "SIMA",
  },
  {
    id: "tbestacao",
    name: "Estações (metadados)",
    description: "Informações das estações/SIMA (rótulo, coordenadas, período ativo).",
    colunas: [
      { nome: "idestacao", label: "ID Estação", type: "string" }, // contém códigos alfanuméricos também
      { nome: "idHexadecimal", label: "ID Hexadecimal", type: "string" },
      { nome: "rotulo", label: "Rótulo / Nome", type: "string" },
      { nome: "lat", label: "Latitude", type: "number" },
      { nome: "lng", label: "Longitude", type: "number" },
      { nome: "inicio", label: "Início (data)", type: "date" },
      { nome: "fim", label: "Fim (data)", type: "date" },
    ],
    responsible: "SIMA",
  },
  {
    id: "tbsensor",
    name: "Sensores (catálogo)",
    description: "Catálogo de sensores usados nas estações (fabricante, modelo, faixa, precisão).",
    colunas: [
      { nome: "idSensor", label: "ID Sensor", type: "number" },
      { nome: "nome", label: "Nome do Sensor", type: "string" },
      { nome: "fabricante", label: "Fabricante", type: "string" },
      { nome: "modelo", label: "Modelo", type: "string" },
      { nome: "faixa", label: "Faixa de Medição", type: "string" },
      { nome: "precisao", label: "Precisão", type: "string" },
    ],
    responsible: "SIMA",
  },
  {
    id: "tbsima",
    name: "SIMA (dados online)",
    description: "Séries temporais coletadas pelo SIMA (vento, temperatura, sondas, radiação, CO₂, precipitação, etc.).",
    colunas: [
      { nome: "idestacao", label: "ID Estação", type: "string" },
      { nome: "dataHora", label: "Data e Hora", type: "date" },
      { nome: "regno", label: "Registro (regno)", type: "string" },
      { nome: "nofsamples", label: "Nº de amostras", type: "number" },
      { nome: "proamag", label: "proamag", type: "string" },
      { nome: "dirvt", label: "Direção do vento (°)", type: "number" },
      { nome: "intensvt", label: "Intensidade do vento (m/s)", type: "number" },
      { nome: "u_vel", label: "Velocidade zonal (u)", type: "number" },
      { nome: "v_vel", label: "Velocidade meridional (v)", type: "number" },
      { nome: "tempag1", label: "Temp. água 2m (°C)", type: "number" },
      { nome: "tempag2", label: "Temp. água 5m (°C)", type: "number" },
      { nome: "tempag3", label: "Temp. água 20m (°C)", type: "number" },
      { nome: "tempag4", label: "Temp. água 40m (°C)", type: "number" },
      { nome: "tempar", label: "Temp. ar (°C)", type: "number" },
      { nome: "ur", label: "Umidade relativa (%)", type: "number" },
      { nome: "tempar_r", label: "Temp. ar (relação)", type: "number" },
      { nome: "pressatm", label: "Pressão atmosférica (hPa)", type: "number" },
      { nome: "radincid", label: "Radiação incidente (W/m²)", type: "number" },
      { nome: "radrefl", label: "Radiação refletida (W/m²)", type: "number" },
      { nome: "bateria", label: "Bateria (painel?)", type: "number" },
      { nome: "sonda_temp", label: "Temp. da sonda (°C)", type: "number" },
      { nome: "sonda_cond", label: "Condutividade (uS/cm)", type: "number" },
      { nome: "sonda_DOsat", label: "DO (%)", type: "number" },
      { nome: "sonda_DO", label: "DO (mg/l)", type: "number" },
      { nome: "sonda_pH", label: "pH (sonda)", type: "number" },
      { nome: "sonda_NH4", label: "NH4+ (mg/l)", type: "number" },
      { nome: "sonda_NO3", label: "NO3- (mg/l)", type: "number" },
      { nome: "sonda_turb", label: "Turbidez (NTU)", type: "number" },
      { nome: "sonda_chl", label: "Clorofila (ug/l)", type: "number" },
      { nome: "sonda_bateria", label: "Bateria da sonda (V)", type: "number" },
      { nome: "corr_norte", label: "Vel. meridional corrente (cm/s)", type: "number" },
      { nome: "corr_leste", label: "Vel. zonal corrente (cm/s)", type: "number" },
      { nome: "co2_low", label: "CO2 low", type: "number" },
      { nome: "co2_high", label: "CO2 high", type: "number" },
      { nome: "precipitacao", label: "Precipitação", type: "number" },
    ],
    responsible: "SIMA",
  },
  {
    id: "tbsimaoffline",
    name: "SIMA Offline (dados históricos/offline)",
    description: "Versão offline/histórica dos dados SIMA (registro de sensores quando não havia link online).",
    colunas: [
      { nome: "idestacao", label: "ID Estação", type: "string" },
      { nome: "dataHora", label: "Data e Hora", type: "date" },
      { nome: "dirvt", label: "Direção do vento (°)", type: "number" },
      ...
      { nome: "radincid", label: "Radiação incidente (W/m²)", type: "number" },
      { nome: "radrefl", label: "Radiação refletida (W/m²)", type: "number" },
      { nome: "fonteRadiometro", label: "Fonte Radiômetro", type: "string" },
      { nome: "sonda_temp", label: "Temp. da sonda (°C)", type: "number" },
      { nome: "sonda_cond", label: "Condutividade (uS/cm)", type: "number" },
      { nome: "sonda_DO", label: "DO (mg/l)", type: "number" },
      { nome: "sonda_pH", label: "pH (sonda)", type: "number" },
      ...
      { nome: "corr_norte", label: "Vel. meridional corrente (cm/s)", type: "number" },
      { nome: "corr_leste", label: "Vel. zonal corrente (cm/s)", type: "number" },
      { nome: "bateriaPainel", label: "Bateria do painel", type: "number" },
    ],
    responsible: "SIMA",
  },
]}
