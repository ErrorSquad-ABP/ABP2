          ...
          <Column>
            <Block>
              ...
              <BlockText>
                <ul>
                  <li>
                    Padronização de metodologia para o cálculo das emissões de gases de efeito
                    estufa em reservatórios;
                  </li>
                  <li>
                    Modelo de emissão de longo prazo de gases de efeito estufa por reservatórios;
                  </li>
                  <li>
                    Artigos em revistas especializadas e publicação de livro, incluindo versão
                    voltada à comunidade científica internacional;
                  </li>
              ...
              <BlockText>
                <ul>
                  ...
                  <li>
                    ...
                    dissertações de mestrado e 6 teses de doutorado, além de cursos de
                    especialização;
                  </li>
                  <li>
              ...
              <BlockText>
                <ul>
                  ...
                  <li>
                    ...
                    – Organização do banco de dados do projeto, instalação de plataformas
                    telemétricas de dados ambientais, estimativa de fluxos de GHG na interface
                    água-atmosfera, análise isotópica (CENA-USP) e modelagem dos fluxos de emissão
                    de GHG.
                  </li>
                </ul>
              </BlockText>
        ...
        <>
            ...
            <BlockText>
              <ul>
                ...
                <li>
                  ...
                  review
                  <br />
                  ADAMS, D. D. — In: D. D. Adams, S. P. Seitzinger and P. M. Crill, Mitteilungen
                  (Communications) No. 25, International Association of Theoretical and Applied
                ...
                <li>
                  ...
                  <br />
                  ADAMS, D. D. — Dams and Climate Change, Luiz P. Rosa and Marco A. dos Santos,
                ...
                <li>
                  ...
                  <br />
                  ADAMS, D. D.; DELMAS, R.; LE, M.; VARFALVY L.; NOVO, E. M. L. M.; GOSSE P.; BOON,
            ...
            <BlockText>
              <ul>
                ...
                <li>
                  ...
                  GRÉGOIRE, A. — In: Greenhouse gases emissions from natural environments and
                ...
                <li>
                  ...
                  <br />
                  DUMESTRE, J. F.; GUEZENNEC, J.; GALY-LACAUX, C.; DELMAS, R.; RICHARD, S.; LABROUE,
                  L. — Applied and Environmental Microbiology, 65, 534 - 539, 1999
                </li>
              </ul>
            </BlockText>
          </Block>
          ...
          <Block>
            ...
            <BlockText>
              <ul>
                <li>
                  Greenhouse gas emissions from hydroelectric reservoir (Brazil's Tucuruí dam) and
                  the energy policy implications
                  <br />
                ...
                <li>
                  ...
                  intertropical dam
                  <br />
                  GOSSE, P.; ABRIL, G.; GUÉRIN, F.; RICHARD, S.; DELMAS, R. — Verhandlungen der
                ...
                <li>
                  ...
                  <br />
                  GOSSE, P.; ABRIL, G.; GUERIN, F.; RICHARD, S.; DELMAS, R. — Verhandlungen der
                  Internationalen Vereinigung für Theoretische und Angewandte Limnologie, 29,
                  594-600, 2005
                </li>
                ...
                <li>
                  ...
                  <br />
                  GUÉRIN, F.; ABRIL, G.; SERÇA, D.; DELON, C.; RICHARD, S.; DELMAS, R.; TREMBLAY,
                  A.; VARFALVY, L. — Journal of Marine Systems, 66, 161-172, 2006
                </li>
              </ul>
            </BlockText>
          </Block>
            ...
            <BlockText>
              <ul>
                ...
                <li>
                  ...
                  <br />
                  LIMA, I. B. T.; NOVO, E. M. L. M. — In: Proceedings of International Workshop on
                  Hydro Dams, Lakes and Greenhouse Gas Emissions, Rio de Janeiro, Brazil,
                  COPPE-UFRJ, pp.78-84, 1999
                </li>
              </ul>
            </BlockText>
          </Block>
            ...
            <BlockText>
              <ul>
                ...
                <li>
                  ...
                  GOSSE, P.; HOREAU, V.; LABROUE, L.; SISSAKIAN, C. — Verhandlungen der
                  Internationalen Vereinigung für Theoretische und Angewandte Limnologie, 27,
                  1454-1458, 2000
                </li>
              </ul>
            </BlockText>
          ...
          <Block>
            ...
            <BlockText>
              <ul>
                <li>
                  Impact of methane oxidation in tropical reservoirs on greenhouse gas fluxes and
                  water quality
                  <br />
                ...
                <li>
                  ...
                  <br />
                  ROSA, L. P.; SANTOS, M. A. (eds.) — Proceedings of International Workshop on
                ...
                <li>
                  ...
                  Brazil
                  <br />
                  ROSA, L. P.; SANTOS, M. A.; TUNDISI, J. G.; SIKAR, B. M. — In: Hydropower Plants
                ...
                <li>
                  ...
                  <br />
                  SIKAR, E.; SANTOS, M. A.; MATVIENKO, B.; SILVA, M. B.; ROCHA, C. H. E. D.; SANTOS,
        ...
        <PageContainer>
            ...
            <BlockText>
              <ul>
                ...
                <li>
                  ...
                  vezes menos gases de efeito estufa que termelétricas. Revista Furnas, junho de
                  2007
                </li>
                <li>
                  FURNAS inicia pesquisa de balanço de carbono em reservatórios - Linha Direta Nº
                  297, 14 de junho de 2003
                </li>
              </ul>
            </BlockText>
          </Block>
            ...
            <BlockText>
              <ul>
                <li>
                  ...
                  <br />
                  <i>
                    In: Global Warming and Hydroelectric Reservoirs. COPPE/UFRJ e Eletrobrás, 2005
                  </i>
                </li>
                <li>
                ...
                <li>
                  Carbon dioxide and methane fluxes in the littoral zone of a tropical savanna
                  reservoir (Corumbá, Brazil).
                ...
                <li>
                  ...
                  hydroreservoirs. <i>Verhandlungen, 2005</i>
                </li>
                <li>Satellite ecohydrology and multifractals: INPE Relatório Técnico</li>
                <li>
                  The use of remote sensing and automated water quality systems...{" "}
                  <i>Greenhouse gas emissions from hydropower reservoirs, COPPE/UFRJ, 2004</i>
                </li>
                <li>
                  Extreme event dynamics in methane ebullition fluxes...{" "}
                  <i>Geophysical Research Letters, 2006</i>
                </li>
                <li>
                  Long term monitoring of greenhouse gas emissions... <i>COPPE/UFRJ, 2004</i>
                </li>
                <li>
                  Carbon dioxide and methane emissions from hydroelectric reservoirs in Brazil.{" "}
                  <i>Global Warming and Hydroelectric Reservoirs, 2005</i>
                </li>
                <li>
                  Global warming and hydroelectric reservoirs. <i>COPPE/UFRJ, 2005</i>
                </li>
                <li>
                  Gross greenhouse gas fluxes from hydro-power reservoir compared to thermo-power
                  plants. <i>Energy Policy, 2005</i>
                </li>
                <li>
                  Greenhouse gases and initial findings on the carbon circulation...{" "}
                  <i>Verhandlungen, 2005</i>
                </li>
                <li>
                  Caminhos do carbono em ecossistemas aquáticos continentais.{" "}
                  <i>Lições de Limnologia, 2005</i>
                </li>
                <li>
                  Variability of carbon dioxide flux from tropical (Cerrado) hydroelectric
                  reservoirs. <i>Aquatic Sciences, 2010</i>
                </li>
                <li>
                  Silicon as a permanent-carbon sedimentation tracer. <i>Inland Waters, 2012</i>
                </li>
              </ul>
            </BlockText>
          </Block>
          ...
          <Block>
            ...
            <BlockText>
              <ul>
                ...
                <li>
                  Greenhouse gas concentrations and diffusive flux at the sediment-water
                  interface... (Brasil)
                </li>
                ...
                <li>
                  Carbon gas cycling in the sediments of Serra da Mesa and Manso reservoirs...
                </li>
                <li>Theoretical diffusive flux of greenhouse gases...</li>
                <li>
                  Carbon budget in hydroelectric reservoirs of Furnas Centrais Elétricas S.A.,
                  Brazil
                </li>
                ...
                <li>
                  Does methane from hydro-reservoirs fizz out from the water upon turbine discharge?
                </li>
          ...
          <Block>
            ...
            <BlockText>
              <ul>
                <li>
                  Trophic classifications between temperate and tropical aquatic ecosystems...{" "}
                  <i>11th World Lakes Conference, 2005</i>
                </li>
                <li>
                  Carbon budget in hydroelectric reservoirs of FURNAS...{" "}
                  <i>Proceedings IAL, 2005</i>
                </li>
                <li>
                  Concentração de oxigênio e suas implicações no metabolismo bacteriano...{" "}
                  <i>XXIII Congresso Brasileiro de Microbiologia, 2005</i>
                </li>
                <li>
                  Ferramentas para abrir uma caixa, ainda, nebulosa...{" "}
                  <i>X Congresso Brasileiro de Limnologia, 2005</i>
                </li>
                <li>
                  Carbon budget in two neotropical reservoirs...{" "}
                  <i>ASLO Aquatic Sciences Meeting, 2006</i>
                </li>
                <li>
            ...
            <BlockText>
              <ul>
                <li>
                  ...
                  abundância e biomassa em carbono. <i>UNIRIO, 2005</i>
                </li>
                <li>
                  Dinâmica horizontal do fitoplâncton no reservatório de Serra da Mesa (GO)...{" "}
                  <i>UNIRIO, 2007</i>
                </li>
              </ul>
            </BlockText>
