...
export function PublicacoesSection() {
  return (
    <TwoColumnContainer>
      <Column>
        <PubSection>
          <PubSectionTitle>Artigos</PubSectionTitle>
          ...
          <PubLink href="http://epacis.org/files/JCIS11-art.06.PDF" target="_blank">
        ...
        <PubSection>
          <PubSectionTitle>Eventos</PubSectionTitle>

          <PubLink href="http://www.dsr.inpe.br/sbsr2011/files/p0144.pdf" target="_blank">
            <span className="autor">
          ...
          <PubLink href="http://www.dsr.inpe.br/sbsr2011/files/p0862.pdf" target="_blank">
            <span className="autor">
        ...
        <PubSection>
          <PubSectionTitle>Teses e dissertações</PubSectionTitle>
          ...
          <PubLink href="http://urlib.net/8JMKD3MGP7W/3E57SM2" target="_blank">
          ...
          <PubLink href="http://urlib.net/8JMKD3MGP7W/3B97FFL" target="_blank">
