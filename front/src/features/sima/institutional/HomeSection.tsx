      ...
      <Column>
        <Block>
          ...
          <BlockText>
            ...
            transmissão. Os dados coletados em intervalo de tempo pré-programado são transmitidos
            via satélite e também armazenados na estação de coleta, sendo que os dados armazenados
            são aqueles obtidos com maior frequência. Este portal permite o acesso aos dados
            transmitidos por satélite poucas horas após a coleta. A associação destas componentes
            fornece uma poderosa ferramenta que pode ser empregada no gerenciamento e controle
            ambiental de recursos hídricos.
          </BlockText>
        </Block>
          ...
          <BlockText>
            <ul>
              ...
              <li>
                ...
                esquema de carrossel. A transmissão é executada independente de existir satélite
              ...
              <li>
                ...
                dados são processados para filtrar falhas na transmissão e para posterior envio para
                a DSR (Divisão de Sensoriamento Remoto) do INPE de São José dos Campos - SP, onde os
              ...
              <li>
                Armazenamento interno: alguns SIMAs possuem a capacidade de armazenar as coletas
                para posterior download por um técnico{" "}
                <span style={{ fontStyle: "italic" }}>in situ</span>, ou seja, estes dados não são
      ...
      <Column>
        <Block>
          ...
          <BlockText>
            ...
            (foto abaixo e a esquerda) ou uma estrutura maior (foto abaixo e a direita). No centro
            ...
            baterias e transmissor de satélite. Os sensores submersos são conectados a eletrônica
            por cabos.
            <ImageRow>
        ...
        <Block>
          ...
          <BlockText>
            ...
            ano e os dados coletados foram disponibilizados pelo Programa Nacional de Bóia. Os dados
            coletados neste período foram comparados com dados{" "}
            <span style={{ fontStyle: "italic" }}>in situ</span>, o que confirmou o bom desempenho
            do sistema.
          </BlockText>
        </Block>
          ...
          <BlockText>
            <ul>
              ...
              <li>
                ...
                dia. Acontece que nem sempre são recebidas todas as leituras, pois o sistema
                necessita de satélites para completar a transmissão e por questão de posicionamento
