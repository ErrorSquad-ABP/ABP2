          ...
          <BlockText>
            <ul>
              ...
              <li>
                ...
                vezes menos gases de efeito estufa que termelétricas. Revista Furnas, junho de 2007
              </li>
              <li>
                FURNAS inicia pesquisa de balanço de carbono em reservatórios - Linha Direta Nº 297,
                14 de junho de 2003
              </li>
            </ul>
          </BlockText>
        ...
        <Block>
          ...
          <BlockText>
            <ul>
              ...
              <li>
                Greenhouse gas concentrations and diffusive flux at the sediment-water interface...
                (Brasil)
              </li>
        ...
        <Block>
          ...
          <BlockText>
            <ul>
              ...
              <li>
                Carbon budget in hydroelectric reservoirs of FURNAS... <i>Proceedings IAL, 2005</i>
              </li>
              <li>
